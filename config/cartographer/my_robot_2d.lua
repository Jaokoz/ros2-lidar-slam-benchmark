...
options = {
  ...
  -- Cartographer publikuje TF map -> odom,
  -- a robot/odometria publikuje odom -> base_link.
  provide_odom_frame = true,

  publish_frame_projected_to_2d = true,

  -- Cartographer używa odometrii jako pomocniczej informacji ruchu.
  use_odometry = true,
...
-- Jeden skan naraz. Przy skrętach nie rozmywa geometrii.
TRAJECTORY_BUILDER_2D.num_accumulated_range_data = 1

-- ============================================================
-- LOKALNE DOPASOWANIE SKANÓW
-- ============================================================
